...
def main():
    ...
    while True:
        ...
        if nomePrato:
            ...
            total += precoPrato
            print(f"\nAdicionado: {nomePrato} - R$ {precoPrato:.2f}")
        else:
            print("\nCódigo inválido.")

        adicionarOutroPrato = input("Deseja adicionar mais um prato? (s/n): \n").lower()
    ...
    formaPagamento = input("Escolha a forma de pagamento (à vista/à prazo): \n").lower()
